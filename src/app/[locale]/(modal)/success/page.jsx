    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-[#0C1844] bg-opacity-50 flex items-center justify-center z-50"
        >
          <motion.div
          ...
          >
            <div className="text-center">
              <motion.div
                ...
                className="w-20 h-20 bg-[#0C1844]/10 rounded-full mx-auto flex items-center justify-center"
              >
                <svg
