...
export function InfoModal({ isOpen, onClose, message }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#1E3CAA3B]/80 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
        <div className="text-center">
          <div className="w-20 h-20 bg-[#0C1844] hover:bg-[#0C1844] rounded-full mx-auto flex items-center justify-center">
            <svg
